...
CKEDITOR.plugins.setLang('autosave', 'en', {
    ...
    savedContentLoaded: 'Loaded auto-saved version of this content from "{0}"',
    loadSavedContent: 'An auto-saved version of this content from "{0}" has been found. Would you like to load it?',

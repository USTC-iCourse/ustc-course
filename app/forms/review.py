...
class ReviewForm(FlaskForm):
    ...
    difficulty = IntegerField('grading',validators=[Optional(), NumberRange(1,3)])
    homework = IntegerField('homework',validators=[Optional(), NumberRange(1,3)])
    grading = IntegerField('grading',validators=[Optional(), NumberRange(1,3)])
    gain = IntegerField('gain',validators=[Optional(), NumberRange(1,3)])
    rate = IntegerField('rate',validators=[Optional(), NumberRange(1,10)])

...
def set_banner():
  ...
  return render_template('admin/edit-banner.html', form=BannerForm(), banner=banner, banner_history=banner_history,
                         title='Banner 设置')
...
def edit_announcement(announcement_id):
  ...
  return render_template('admin/edit-announcement.html', form=AnnouncementForm(), announcement=announcement,
                         title='编辑公告')

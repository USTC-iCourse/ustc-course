...
def signin_3rdparty():
  ...
  if status and confirmed:
    ...
    auth_str = 'challenge=' + urllib.parse.quote(
      challenge) + '&date=' + quoted_date + '&email=' + quoted_email + '&status=200'
    ...
    return render_template('signin-3rdparty.html', form=request.form, error=error, from_app=from_app, next_url=next_url,
                           challenge=challenge)

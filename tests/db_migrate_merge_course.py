...
cursor.execute(
  "INSERT INTO old_courses SELECT courses.*, GROUP_CONCAT(DISTINCT teacher_id ORDER BY teacher_id SEPARATOR ' ') AS teacher_list FROM courses LEFT JOIN course_teachers ON courses.id=course_teachers.course_id GROUP BY courses.id")
...
cursor.execute(
  "INSERT INTO new_courses (name, teacher_list, dept_id, _image) SELECT name, teacher_list, dept_id, _image FROM old_courses GROUP BY name, teacher_list")
...
cursor.execute(
  "INSERT INTO new_course_teachers SELECT DISTINCT new_courses.id AS course_id, course_teachers.teacher_id FROM new_courses JOIN old_courses ON new_courses.teacher_list=old_courses.teacher_list AND new_courses.name=old_courses.name JOIN course_teachers ON old_courses.id=course_teachers.course_id")
...
cursor.execute(
  "INSERT INTO new_course_rates (id, %s) SELECT new_courses.id, %s FROM course_rates JOIN old_courses ON course_rates.id=old_courses.id JOIN new_courses ON old_courses.name=new_courses.name AND old_courses.teacher_list=new_courses.teacher_list GROUP BY old_courses.name, old_courses.teacher_list" %
...
cursor.execute(
  "INSERT INTO course_terms (id, course_id, %s) SELECT old_courses.id, new_courses.id AS course_id, %s FROM old_courses JOIN new_courses ON old_courses.name=new_courses.name AND old_courses.teacher_list=new_courses.teacher_list GROUP BY old_courses.name, old_courses.teacher_list, old_courses.term" %
...
cursor.execute(
  "INSERT INTO course_classes (id, course_id, term, cno) SELECT old_courses.id, new_courses.id AS course_id, term, cno FROM old_courses LEFT JOIN new_courses ON old_courses.name=new_courses.name AND old_courses.teacher_list=new_courses.teacher_list")
...
cursor.execute(
  "INSERT INTO new_follow_course (course_id, user_id) SELECT DISTINCT course_classes.course_id, user_id FROM follow_course JOIN course_classes ON follow_course.course_id=course_classes.id")
...
cursor.execute(
  "INSERT INTO new_join_course (class_id, student_id) SELECT course_classes.id AS class_id, student_id FROM join_course JOIN course_classes ON join_course.course_id=course_classes.id")
...
cursor.execute(
  "INSERT INTO new_upvote_course (course_id, user_id) SELECT DISTINCT course_classes.course_id, user_id FROM upvote_course JOIN course_classes ON upvote_course.course_id=course_classes.id")
...
cursor.execute(
  "INSERT INTO new_downvote_course (course_id, user_id) SELECT DISTINCT course_classes.course_id, user_id FROM downvote_course JOIN course_classes ON downvote_course.course_id=course_classes.id")
...
cursor.execute(
  "INSERT INTO new_review_course (course_id, user_id) SELECT DISTINCT course_classes.course_id, user_id FROM review_course JOIN course_classes ON review_course.course_id=course_classes.id")
...
_review_props = ['author_id', 'difficulty', 'homework', 'grading', 'gain', 'rate', 'content', 'publish_time',
                 'update_time', 'upvote_count', 'comment_count']
cursor.execute(
  "INSERT INTO new_reviews (course_id, term, id, %s) SELECT course_classes.course_id, term, reviews.id, %s FROM reviews JOIN course_classes ON reviews.course_id=course_classes.id GROUP BY course_classes.course_id, author_id, term" %

...
program_courses_map = {str(program_course.program_id) + '|' + str(program_course.course_group_code): program_course for
                       program_course in existing_program_courses}
  ...
  for json_dept_id in tree:
    ...
    for major_id in dept_data['majors']:
      ...
      for program_data in programs:
        ...
        print(
          'Loaded ' + str(count) + ' courses in ' + program.train_type + ' ' + dept_name + ' ' + major.name + ' ' + str(
